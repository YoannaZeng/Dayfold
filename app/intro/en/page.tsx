...
export const metadata: Metadata = {
  title: "Dayfold | Real Progress Tracking",
  description: "Dayfold helps knowledge workers record plans, actual progress, and weekly reviews so invisible work has evidence."
};
